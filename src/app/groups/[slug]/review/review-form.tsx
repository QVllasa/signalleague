...
export function ReviewForm({ groupId, groupName, slug }: ReviewFormProps) {
        ...
        <div className="mx-auto max-w-2xl px-4 sm:px-6 py-12">
          <div className="space-y-2 mb-8">
            ...
            <p className="text-sm text-muted-foreground font-mono">
              ...
              <span className="text-foreground">{groupName}</span>. Rate across
              5 categories.
            </p>
          </div>
          ...
          <form action={action} className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input name="pros" placeholder="Comma-separated pros" />
                <p className="text-xs text-muted-foreground">
              ...
              <div className="space-y-2">
                ...
                <Input name="cons" placeholder="Comma-separated cons" />
                <p className="text-xs text-muted-foreground">
                  Separate with commas
                </p>
              </div>
